...
**3. Flood Statistics & Severity Estimation:**
...
**Limitations:**
* Trained exclusively on the Sen1Floods11 dataset.
...
**Future Scope:**
* Implement multi-temporal flood change detection (before vs. after comparisons).
